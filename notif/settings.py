...
if ALLOWED_HOSTS_ENV:
    ...
    ALLOWED_HOSTS = ["*"]  # в dev разрешаем все хосты
else:
    ALLOWED_HOSTS = []
...
INSTALLED_APPS = [
    ...
    # rest_api и кеширование ORM
    'rest_framework', 'cacheops',
...
# email - для бэка что бы видет отправку
...
# celery берем из редис 
CELERY_BROKER_URL = os.getenv('CELERY_BROKER_URL', REDIS_URL)
CELERY_RESULT_BACKEND = os.getenv('CELERY_RESULT_BACKEND', REDIS_URL)
CELEREY_TASK_TIME_LIMIT = 60 
CELEREY_TASK_SOFT_TIME_LIMIT = 55

#cachEops
CACHEOPS_REDIS = REDIS_URL
CACHEOPS = {'notifications.user': {'ops': 'get', 'timeout': 60},}
